  ...
  const projects = [
    {
      id: 1,
      title: 'ScriptBook',
      image: '/scriptbook.webp',
      link: 'https://scriptbook-rauldev.vercel.app/',
    },
    {
      id: 2,
      title: 'NexusDoc',
      image: '/nexusdoc.webp',
      link: 'https://nexus-doc.onrender.com/',
    },
    {
      id: 3,
      title: 'Dorta',
            ...
            <motion.div
              ...
              <div className='aspect-video bg-zinc-900/50 border border-white/5 rounded-3xl flex items-center justify-center relative overflow-hidden mb-6 transition-all duration-500 group-hover:border-cyan-400/40 group-hover:shadow-[0_0_50px_rgba(0,242,255,0.2)]'>
                {p.image ? (
                  <Image
                    ...
                    alt={`Proyecto ${p.id}`}
                    fill
                    className='absolute inset-0 w-full h-full object-cover opacity-50 group-hover:opacity-100 grayscale group-hover:grayscale-0 scale-100 group-hover:scale-110 transition-all duration-700'
                  />
                ) : (
              ...
              <div className='flex items-center justify-between px-4'>
                ...
                <Link
                  href={p.link}
                  target='_blank'
                  className='text-zinc-500 hover:text-cyan-400 hover:drop-shadow-[0_0_10px_rgba(34,211,238,0.6)] transition-all transform hover:scale-110'
                  title='Live'>
