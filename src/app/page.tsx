    ...
    <div className='min-h-screen text-white selection:bg-cyan-400/30'>
      ...
      <BubbleBackground interactive={true}>
        <main className='relative z-10 bg-transparent flex flex-col'>
          ...
          <TechStack />
          <Contact />
          {/* Llama al componente Footer aquí */}
          <Footer />
        </main>
      </BubbleBackground>
    </div>
...
// Componente Footer definido correctamente fuera de Home
export const Footer = () => {
  return (
      ...
      <div className='max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8'>
        ...
        <div className='flex flex-col items-center md:items-start'>
          <div className='text-white font-black tracking-tighter text-xl mb-2'>
            ...
            <span className='text-[10px] text-zinc-500 font-mono ml-1'>.web</span>
          </div>
        ...
        <div className='text-center'>
          <p className='text-zinc-400 text-[11px] font-mono uppercase tracking-widest'>
            ...
            de{' '}
            <span className='text-cyan-400 font-bold'>CunaguarosDev</span>
          </p>
        </div>
